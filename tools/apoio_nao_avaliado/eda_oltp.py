#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Análise Exploratória (EDA) das bases de origem do projeto.
...
# ---------------------------------------------------------------------------
# A. Job Bank / ESDC — dataset bruto de origem
# ---------------------------------------------------------------------------
section("A. Job Bank/ESDC — raw/job_bank_wages_2025.csv (dataset de salários)")
...
# ---------------------------------------------------------------------------
# C. Statistics Canada — imigração (extração de origem)
# ---------------------------------------------------------------------------
